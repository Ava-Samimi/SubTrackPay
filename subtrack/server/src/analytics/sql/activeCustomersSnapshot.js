// server/src/analytics/sql/activeCustomersSnapshot.js

/**
 * Builds SQL for: count of DISTINCT customers who have at least one active subscription
 ...
 */
export function buildActiveCustomersSnapshotSQL(basis = "monthly", yearsBack = 10) {
...
SELECT
  b.bucket_start,
  COUNT(DISTINCT s."customerID")::int AS active_customers
FROM buckets b
